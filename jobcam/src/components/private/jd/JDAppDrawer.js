...
const JDAppDrawer = ({ children }) => {
    ...
    return (
        <Box sx={{
            display: 'flex', flexFlow: 1, flexShrink: 0
                    ...
                    >
                        <ListItem>
                            ...
                            >
                                ...
                                <ListItemText primary={'JDashboard'} />
                            </ListItemButton>
                        </ListItem>
                        ...
                        <ListItem>
                            <ListItemButton
                                ...
                                to='jdlist'
                                onClick={() => isLarge ? null : setOpen(false)}
                                selected={location.pathname === '/jdlist'}
                            >
                                <ListItemIcon>
                                    <FormatListBulletedIcon />
                                </ListItemIcon>
                                <ListItemText primary={'ListOfJD'} />
                            </ListItemButton>
                        </ListItem>
                        <ListItem>
                            <ListItemButton
                                ...
                                to='jdform'
                                onClick={() => isLarge ? null : setOpen(false)}
                                selected={location.pathname === '/jdform'}
                            >
                                <ListItemIcon>
                                    <FeedIcon />
                                </ListItemIcon>
                                <ListItemText primary={'JDForm'} />
                            </ListItemButton>
                        </ListItem>
                        <ListItem>
                            <ListItemButton
