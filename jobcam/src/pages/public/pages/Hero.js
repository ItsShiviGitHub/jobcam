...
import { slides } from '../../../apiData/data';
                            ...
                            <Box sx={{
                                ...
                                <Stack sx={{ py: { md: spacing(10), xs: spacing(5) } }}>
                                    ...
                                    <Box sx={{ width: '200px', px: { md: spacing(20), xs: spacing(2) }, py: spacing(2) }}>
                                        <NewButton variant={'contained'} style={{ background: palette.primary.main }} onClick={() => navigate('/joinnetwork')}>Join Our Network</NewButton>
                                    </Box>
                                </Stack>
                            </Box>
                        </Stack>
